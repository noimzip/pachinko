...
`
const dataManagementController = new DataManagementController(new DataManagementModel(), new DataManagementView(), "autosave-trigger-checkbox");
...
createModal(document.getElementById("status-modal-trigger-button"), `
  ...
  `);
createModal(document.getElementById("upgrade-modal-trigger-button"), `
